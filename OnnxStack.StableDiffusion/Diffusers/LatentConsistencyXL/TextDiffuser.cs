...
{
    public sealed class TextDiffuser : LatentConsistencyXLDiffuser
    {
        /// <summary>
        ...
        public TextDiffuser(IOnnxModelService onnxModelService, IPromptService promptService, ILogger<LatentConsistencyXLDiffuser> logger)
