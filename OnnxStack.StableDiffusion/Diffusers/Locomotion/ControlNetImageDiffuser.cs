...
namespace OnnxStack.StableDiffusion.Diffusers.Locomotion
{
    public sealed class ControlNetImageDiffuser : ControlNetDiffuser
    {
        ...
        public ControlNetImageDiffuser(ControlNetModel controlNet, UNetConditionModel unet, AutoEncoderModel vaeDecoder, AutoEncoderModel vaeEncoder, FlowEstimationModel flowEstimation, ResampleModel resampler, ILogger logger = default)
