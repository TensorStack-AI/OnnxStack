...
{
    public sealed class ImageDiffuser : LocomotionDiffuser
    {
        ...
        public ImageDiffuser(UNetConditionModel unet, AutoEncoderModel vaeDecoder, AutoEncoderModel vaeEncoder, FlowEstimationModel flowEstimation, ResampleModel resampler, ILogger logger = default)
        ...
        /// </summary>
        public override DiffuserType DiffuserType => DiffuserType.ImageToVideo;
        ...
        {
            return await PrepareImageLatentsAsync(options, scheduler, timesteps, cancellationToken);
        }
