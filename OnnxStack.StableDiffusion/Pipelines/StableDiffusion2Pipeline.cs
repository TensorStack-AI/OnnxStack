...
{
    public sealed class StableDiffusion2Pipeline : StableDiffusionPipeline
    {
        ...
        /// <param name="logger">The logger.</param>
        /// <returns></returns>
        public static new StableDiffusion2Pipeline CreatePipeline(StableDiffusionModelSet modelSet, ILogger logger = default)
        {
            ...
            return new StableDiffusion2Pipeline(config.Name, tokenizer, textEncoder, unet, vaeDecoder, vaeEncoder, controlnet, config.Diffusers, config.Schedulers, config.SchedulerOptions, logger);
        }
        ...
        /// <param name="logger">The logger.</param>
        /// <returns></returns>
        public static new StableDiffusion2Pipeline CreatePipeline(OnnxExecutionProvider executionProvider, string modelFolder, ModelType modelType = ModelType.Base, ILogger logger = default)
        {
            return CreatePipeline(ModelFactory.CreateStableDiffusion2ModelSet(modelFolder, modelType).WithProvider(executionProvider), logger);
        }
    }
}
